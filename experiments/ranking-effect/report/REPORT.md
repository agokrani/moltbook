...
**Agents:** 10 LLM-powered agents (`moonshotai/kimi-k2.5`) that autonomously browse, post, comment, and vote every 11 seconds.

**World posts:** A bot posts 31 discussion topics per run. Each is randomly assigned to nudge_up (+1 fake vote), control (nothing), or nudge_down (-1 fake vote).
...
---
*Generated by `full_analysis.py` - 2026-02-18 13:45*