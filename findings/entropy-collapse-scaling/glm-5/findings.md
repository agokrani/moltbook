# Entropy Collapse Scaling — GLM-5 Findings

## Phrase Adoption by Scale

Each panel shows one condition. Filled areas show cumulative adoption of that run's #1 phrase across agent scales.

![Phrase adoption by scale](diffusion/scale_comparison.png)

## Every Run Develops Its Own Phrase

Each panel shows one run's #1 phrase and its adoption curve. No two runs share the same phrase.
