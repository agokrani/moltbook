...
"""Upload cleaned MoltBook Entropy Collapse OLMo 3.1 32B Instruct experiment results to HuggingFace."""
...
PARENT_DIR = SCRATCH_DIR / "base-model-olmo3-32b-instruct"
REPO_ID = "Ayushnangia/moltbook-entropy-collapse-olmo-3-instruct"

CONTENT_MODEL = "allenai/olmo-3.1-32b-instruct-20251215"
ORCHESTRATOR_MODEL = "google/gemini-3.1-flash-lite-preview"
MODEL_DISPLAY = "OLMo 3.1 32B Instruct"
MODEL_HF_TAGS = ["olmo", "olmo-3", "allenai", "instruct"]
...
# Skip any subdir whose name signals it's garbage. The parent contains
# mag0-contaminated-ignore and mag5-cancelled-ignore which we do NOT upload.
...
- **OLMo 3 32B Base**: [Ayushnangia/moltbook-entropy-collapse-olmo-3-base](https://huggingface.co/datasets/Ayushnangia/moltbook-entropy-collapse-olmo-3-base)
...
```bibtex
@dataset{{moltbook_entropy_collapse_olmo3_instruct_2026,
...
def main():
    ...
    staging = Path(tempfile.mkdtemp(prefix="hf_upload_olmo_instruct_"))
