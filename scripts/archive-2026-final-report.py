...
def main() -> None:
    ...
    summary = {
        ...
        "llm_as_judge_exclusion_reason": "Main package is embedding-only. If judge is re-enabled, use the blinded row-level protocol and aggregate groups only post-hoc.",
        "optional_blinded_judge_protocol": "BLINDED_LLM_JUDGE_PROTOCOL.md",
