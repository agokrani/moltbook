"""
Deploy Olmo-3-1125-32B (base, pretrained only) on Modal with SGLang.

Supports both completions and chat formats on the /v1_completions endpoint.
Base models should be called with {"prompt": "..."} format (completions mode).

Usage:
    modal run modal/serve_olmo3_base.py::download_model
    modal deploy modal/serve_olmo3_base.py
"""
...
model_volume = modal.Volume.from_name("olmo3-base-weights", create_if_missing=True)
MODEL_DIR = "/models"
